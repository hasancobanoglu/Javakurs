 ...
 * Yani  metod yapısının amacı programı modüler hale getirmektir.
 * İsimlendirirken fiil içermelidir.Ayrıca projeyi hatalardan kurtarırken,
 * projenin zamanla gelişse bile kolayca değişiklikler yapılmasını ve anlaşabilir kod yazımını arttırır.
 */
public class C01_MethodIleSifreKontrol {
    public static void main(String[] args) {
        ...
        //boolean sonKontrol=sonKontrolEt(sifre);
  ...
  /* Burayı ben yazmaya çalıştım
  private static boolean sonKontrolEt(String sifre) {
      boolean sonKontrolEt=false;


        return sonKontrolEt=false;
